...
import cn.good.mybatis.reflection.SystemMetaObject;
...
public class MapWrapper extends BaseWrapper{
    ...
    public Object get(PropertyTokenizer prop) {
        // 如果有index，说明是集合,那就要分解集合，调用的是BaseWrapper.resolveCollection和getCollectionValue
    ...
    public Class<?> getSetterType(String name) {
        ...
        if(prop.hasNext()){
            ...
            /*如果属性值为 null (NULL_META_OBJECT)，返回 Object.class 作为默认类型 */
    ...
    /* 用于检查对象是否具有指定名称的可获取属性(getter)，支持检查嵌套属性和集合/Map结构中的属性。*/
    @Override
